...
Examples use placeholder hosts: `https://api.ozanozdil.com` (the resource server hosting the API you want to call) and `https://auth.ozanozdil.com` (the authorization server that handles registration). Real services substitute their own.
...
WWW-Authenticate: Bearer resource_metadata="https://api.ozanozdil.com/.well-known/oauth-protected-resource"
```
...
```json
{
  "resource": "https://api.ozanozdil.com/",
  "resource_name": "Service",
  "resource_logo_uri": "https://ozanozdil.com/logo.png",
  "authorization_servers": ["https://auth.ozanozdil.com/"],
...
```json
{
  ...
  "issuer": "https://auth.ozanozdil.com",
  "token_endpoint": "https://auth.ozanozdil.com/oauth2/token",
  "revocation_endpoint": "https://auth.ozanozdil.com/oauth2/revoke",
  ...
  "agent_auth": {
    "skill": "https://ozanozdil.com/auth.md",
    "identity_endpoint": "https://auth.ozanozdil.com/agent/identity",
    "claim_endpoint": "https://auth.ozanozdil.com/agent/identity/claim",
    "events_endpoint": "https://auth.ozanozdil.com/agent/event/notify",
...

{
  ...
  "registration_id": "reg_...",
  "registration_type": "identity_assertion",
  "claim_url": "https://auth.ozanozdil.com/agent/identity/claim",
  "claim_token": "clm_...",
  "claim_token_expires": "…",
  ...
  "claim": {
    "user_code": "123456",
    "expires_in": 600,
    "verification_uri": "https://auth.ozanozdil.com/login?return_to=%2Fclaim%3Fclaim_attempt_token%3D...",
    "interval": 5
  }
}
```
...
> https://auth.ozanozdil.com/login?return_to=...
...
Full API reference: `https://docs.ozanozdil.com/`.
