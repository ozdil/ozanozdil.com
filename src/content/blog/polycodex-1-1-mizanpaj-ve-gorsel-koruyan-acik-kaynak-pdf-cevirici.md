...
<div class="my-8 rounded-2xl border border-[#27272a] bg-[#121215] p-6 shadow-sm">
  <div class="flex items-center justify-between border-b border-[#27272a] pb-3 mb-6">
    ...
    <span class="text-xs font-mono text-[#38bdf8]">lopdf &amp; Rust Engine</span>
  </div>

  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-xs">
    <div class="p-4 rounded-xl bg-[#18181b] border border-[#27272a]">
      <div class="text-[#38bdf8] font-bold mb-2">// 1. METİN BLOKLARI (BT / ET)</div>
    ...
    <div class="p-4 rounded-xl bg-[#18181b] border border-[#34d399]/30">
      <div class="text-[#34d399] font-bold mb-2">// 2. GÖRSEL DOKUNULMAZLIĞI (Do)</div>
      <p class="text-[#a1a1aa] leading-relaxed">
    ...
    <div class="p-4 rounded-xl bg-[#18181b] border border-[#27272a]">
      <div class="text-[#f43f5e] font-bold mb-2">// 3. Tz MİKROTİPOGRAFİ</div>
      <p class="text-[#a1a1aa] leading-relaxed">
...
1. Çevrilen cümlenin hedef dildeki genişliği (\(W_{yeni}\)), orijinal cümlenin sınır kutusu genişliği (\(W_{orig}\)) ile kıyaslanır.
2. Eğer \(W_{yeni} > W_{orig}\) ise, font boyutu veya satır yüksekliği değiştirilmeden dinamik bir sıkıştırma faktörü hesaplanır:
   $$T_z = \max\left(75.0, \frac{W_{orig}}{W_{yeni}} \times 100.0\right)$$
...
<div class="my-8 rounded-2xl border border-[#27272a] bg-[#121215] p-6 shadow-sm">
  <div class="text-xs font-mono font-semibold uppercase tracking-wider text-[#38bdf8] mb-4">
